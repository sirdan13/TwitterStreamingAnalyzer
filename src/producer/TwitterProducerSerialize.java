...
public class TwitterProducerSerialize {
	...
	public static void main(String[] args) throws Exception {
		...
		StatusListener listener = new StatusListener() {
			...
			public void onTrackLimitationNotice(int numberOfLimitedStatuses) {
				if(System.currentTimeMillis()-TwitterProducerSerialize.lastLimitation>=30000){
					System.out.println();
					System.out.println("Got track limitation notice: " + numberOfLimitedStatuses);
					System.out.println();
					TwitterProducerSerialize.lastLimitation=System.currentTimeMillis();
				}
		...
		int minTweets = 100000;
		 while (true) {
			...
			if (ret == null) {
				...
				tlist.add(t);
				producer.send(new ProducerRecord<String, Tweet>(topicName, Integer.toString(j++), t));
			}
